...
export function TopViewIcon({ className }: IconProps) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="20"
...
export function OpenFileIcon({ className }: IconProps) {
  return (
    <svg
      ...
      className={className}
    >
      <path d="M20 11h-7l-3-3H4a2 2 0 0 0-2 2v10a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2V13a2 2 0 0 0-2-2z" />
...
export function MusicNoteOffIcon({ className }: IconProps) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="24"
